...
########################################################################
# C:\Users\AlexandreSarmento\Documents\R\dataAnalysis_UFRN\BooleanNetworkBioME\TBN_IBN\EGEOD18494_KM2\DataSerie_CSV\ZhouGene\binarized_colab\breast
filename = "~/R/dataAnalysis_UFRN/BooleanNetworkBioME/TBN_IBN/EGEOD18494_KM2/WangGenes/binarized_colab/breast/breast_raw_data"
allTimePoints = list(-4,4,8,12)
mergedSampleList = list()
for(i in 1:100){
  #print(i)
  sampleName = paste("~/R/dataAnalysis_UFRN/BooleanNetworkBioME/TBN_IBN/EGEOD18494_KM2/WangGenes/binarized_colab/breast/breast_raw_data", toString(i), ".csv",sep="")
...
# proxy_O2_0005/dataODE_0.0005_1.0_bin_traj
# proxy_002_10/proxy_nodes_zhou_002_1_bin_traj
for(name in names(binAvgSampleList)){
  fileName =paste("~/R/dataAnalysis_UFRN/BooleanNetworkBioME/TBN_IBN/EGEOD18494_KM2/WangGenes/binarized_colab/breast/binAvg",name,".csv",sep="")
...
plotHeatMap(binAvgSampleList$S1,"breast_KM2_Wang",allTimePoints)
...
# LOOP TO ATTRACTORS AND STATE GRAPH
BN <- loadNetwork("~/R/dataAnalysis_UFRN/BooleanNetworkBioME/TBN_IBN/EGEOD18494_KM2/WangGenes/IBN/IBN_breast.bn")
print(BN)
attrBNS <- getAttractors(BN,type="synchronous")
plotAttractors(attrBNS,
               drawLegend = FALSE,
               mode="table",
               allInOnePlot=TRUE,
               onColor="#dfff00",
...
overExpressed <- fixGenes(BN,c("TP53","MDM2","PTEN","PFKL","VEGF"), 1)
attrOE <- getAttractors(overExpressed,type="synchronous")
...
BN <- loadNetwork("~/R/dataAnalysis_UFRN/BooleanNetworkBioME/TBN_IBN/EGEOD18494_KM2/WangGenes/TBN/TBN_wang.bn")
print(BN)

#pathAttr<- getPathToAttractor(attrBN, rep(0,14))
startState = c(1,0,0,0,1,0,1,0,1,0,0,0,1,0)
plotSequence(network=BN,
             startState,
             onColor="#dfff00",
             offColor = "#05337d")
