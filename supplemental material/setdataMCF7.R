# retrieve time serie
library(GEOquery)
GSEDATA <- getGEO("GSE41491", GSEMatrix=TRUE, AnnotGPL=FALSE)
eset <- GSEDATA[[1]]
...
#expr.GSE41491 <- cbind(expr.GSE41491,Table(gpl)[inds])
...
# GET SYMBOL AND ENSEMBL THROUGH ENTREZID
...
# SET IN A DATA FRAME THE ANNOTATIONS ASSOCIATED: PROBES, ENSGENE,SYMBOL AND DESCRIPTION
...
# NOW RETRIVE EXPERIMENTAL CONDITION, CELL LINE AND SAMPLES AND ASSOCIATE ALL THEM
library("tidyverse")
library("dplyr")
